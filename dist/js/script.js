...
ItemHeaders.forEach(ItemHeader => {
    ...
    var arrLang = {
        "en": {
          ...
          "FAQ4isi1": "The first is by purchasing the Ailox WMS software and installing it on a warehouse server (on-premises).",
          "FAQ4isi2": "The second way is to rent (SaaS) where payments can be made every 3 (three) months. For SaaS, the software uses Ailox wms SaaS which is on our server, and can be accessed from anywhere using the internet network.",
        ...
        "id": {
          ...
          "FAQ4isi1": "Yang pertama dengan membeli software Ailox WMS dan menginstalnya di server gudang (on-premises).",
          "FAQ4isi2": "Cara kedua adalah dengan menyewa (SaaS) dimana pembayaran dapat dilakukan setiap 3 (tiga) bulan sekali. Untuk SaaS software menggunakan Ailox wms SaaS yang ada di server kami, dan dapat diakses dari mana saja dengan menggunakan jaringan internet.",
        ...
        "FAQ4isi": "Ailox wms には 類のライセンスがあります。",
        "FAQ4isi1": "目は、Ailox WMS ソフトウェアを購入し、倉庫サーバー (オンプレミス) にインストールすることです。",
      ...
      "FAQ4isi1": "첫 번째는 Ailox WMS 소프트웨어를 구입하여 웨어하우스 서버(온프레미스)에 설치하는 것입니다.",
      "FAQ4isi2": "두 번째 방법은 3(3)개월마다 결제가 가능한 임대(SaaS)입니다. SaaS의 경우 소프트웨어는 서버에 있는 Ailox wms SaaS를 사용하며 인터넷 네트워크를 사용하여 어디에서나 액세스할 수 있습니다.",
